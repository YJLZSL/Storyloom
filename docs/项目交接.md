...
- **自动更新旧版本引导**：v1.1.4 之前的用户需手动下载安装，v1.4.0 重新生成签名密钥后需再次手动下载

### 后续方向（v1.5.0+）
- **WebGAL 导出**：路线图已规划，待 v1.5.0 实施
- **移动端适配**：基于 v1.4.0 三层渲染模型，实现响应式移动端布局
- **更多粒子预设**：基于渲染层架构，扩展更多动态背景效果
- **性能优化**：PixiJS 渲染层性能调优，支持更高粒子密度
- 详见 [`docs/路线图-v1.3+.md`](./路线图-v1.3+.md)（导出系统 → 视觉升级 → 全文搜索）
...
- [技术架构](./架构设计.md)
- [后续规划](./路线图-v1.3+.md)
- [v1.2.0 交接文档](./交接-v1.2.0.md)
- [v1.2.1 更新日志](./更新日志-v1.2.1.md)
- [v1.3.0 更新日志](./更新日志-v1.3.0.md)

---

*本文档最后更新：2026-06-21（v1.4.0 已发布）*
