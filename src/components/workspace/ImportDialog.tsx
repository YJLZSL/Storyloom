...
import { Dialog, TButton, TRadio, TRadioGroup } from '@/components/ui-tdesign';
import {
  UploadIcon,
  CheckIcon,
  FileCodeIcon,
          ...
          <div className="space-y-4">
            <div>
              ...
              <TButton
                ...
                className="w-full p-6 rounded-md border-2 border-dashed border-border hover:border-primary/50 hover:bg-accent/30 transition-colors flex flex-col items-center gap-2 h-auto"
              >
            ...
            {parseError && (
              <div className="flex items-start gap-2 p-3 rounded-md bg-destructive/10 border border-destructive/20 text-sm text-destructive">
                <CautionIcon className="w-4 h-4 shrink-0 mt-0.5" />
            ...
            {parsedFile && (
              <div>
                ...
                <TRadioGroup
                  value={strategy}
                  onChange={(val) => setStrategy(val as ConflictStrategy)}
                  className="space-y-2"
                >
            ...
            <div className="flex justify-end gap-2 pt-2">
              ...
              <TButton
                ...
                icon={importWorkspace.isPending ? undefined : <UploadIcon className="w-4 h-4" />}
              >
                {importWorkspace.isPending ? '导入中...' : '导入'}
              </TButton>
            </div>
          </div>
        )}
